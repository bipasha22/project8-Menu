...
//section-center is the parent of all the single items
...
function displayMenuItems(menuItems) {
  ...
  // join with '' to remove the commas and updating the dom
...
function displayMenuBtns() {
  const categories = menu.reduce(
    function (values, item) {
      // if array doesn't include the item category then add the category else return the array
